...
Private Sub cboCheckSheet_Click()
        ...
        lblCheckor.Caption = mtBusCheckInfo(i).szChecker
        lblCheckGate.Caption = mtBusCheckInfo(i).szCheckGateName
...
Private Sub FillDefaultInfo()
    '填充缺省信息
    lblBus.Caption = ""
    lblDate.Caption = ""
    lblStartTime.Caption = ""
    lblStartCheckTime.Caption = ""
    lblStopCheckTime.Caption = ""
    lblCheckSheetNo.Caption = ""
    ...
    lblSellSum.Caption = ""
    lblCheckSum.Caption = ""
    lblChangeCheckSum.Caption = ""
    lblNoCheckSum.Caption = ""
    lblCheckor.Caption = ""
End Sub
