...
Begin VB.Form frmTicketInfo 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         Height          =   480
         Left            =   195
         Picture         =   "frmTicketInfo.frx":000C
         Top             =   210
         Width           =   480
      End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.Image Image2 
         Height          =   480
         Left            =   210
         Picture         =   "frmTicketInfo.frx":08F2
         Top             =   285
         Width           =   480
      End
   End
...
'    lblStartTime.Caption = Format(moSeviceTicket.REBusDate, "YYYY-MM-DD HH:MM:SS")
    ...
    lblTicketType.Caption = IIf(moSeviceTicket.TicketType = TP_FreeTicket, "免票", IIf(moSeviceTicket.TicketType = TP_FullPrice, "全票", "半票"))
    lblToStation.Caption = moSeviceTicket.SellStationName & " — " & moSeviceTicket.ToStationName
