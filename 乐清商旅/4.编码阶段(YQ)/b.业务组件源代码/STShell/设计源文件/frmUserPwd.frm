...
Private Sub cmdOk_Click()
    On Error GoTo here
    m_oActiveUser.ChangePassword txtOldPassword.Text, txtNewPassword.Text, txtConfirmPassword.Text
...
Private Sub Form_Load()
    lblUserID.Caption = m_oActiveUser.UserID & "/" & m_oActiveUser.UserName
    
    lblUnitName.Caption = m_oActiveUser.UserUnitName
End Sub
