...
Begin VB.Form frmCompany 
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmCompany.frx":0E5E
      PICN            =   "frmCompany.frx":0E7A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
...
Private Sub Form_Load()
    ...
    Set moCompany = CreateObject("STBase.Company")
