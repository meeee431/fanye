...
Begin VB.Form frmSection 
   ...
   Begin VB.TextBox txtPathNo 
      ...
      Width           =   795
   End
   Begin RTComctl3.CoolButton cmdPassCharge 
      Height          =   345
      Left            =   5610
      TabIndex        =   17
      Top             =   495
...
Public m_bIsInsertSection As Boolean '是否插入路段
...
'            txtSectionID.Enabled = True
        ...
        ElseIf m_bRouteArrange Then
            ...
            Unload Me
        ElseIf m_bIsInsertSection Then
            Unload Me
        End If
'        cmdOk.Caption = "保存(&S)"
    Case EFS_Modify '修改
...
Private Sub Form_Load()
    ...
    End Select
    cmdOk.Enabled = False
    If m_eStatus = EFS_AddNew Then txtSectionID.Enabled = True
    Exit Sub
ErrorHandle:
    ShowErrorMsg
End Sub
