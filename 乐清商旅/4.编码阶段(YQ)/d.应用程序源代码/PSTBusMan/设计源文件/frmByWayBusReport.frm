...
Begin VB.Form frmByWayBusReport 
   BackColor       =   &H80000005&
   Caption         =   "途经班次表"
   ClientHeight    =   6270
   ClientLeft      =   60
   ...
   Begin VB.PictureBox ptResult 
      ...
      Begin VB.PictureBox ptQ 
         ...
         Height          =   1155
         Left            =   0
         Picture         =   "frmByWayBusReport.frx":0000
         ScaleHeight     =   1155
         ScaleWidth      =   5640
         TabIndex        =   12
         Top             =   0
         ...
         Begin VB.Image imgOpen 
            Height          =   240
            Left            =   0
            Picture         =   "frmByWayBusReport.frx":0EF6
            Top             =   0
            Visible         =   0   'False
            Width           =   240
         End
   ...
   Begin VB.PictureBox ptQuery 
      ...
      Begin RTComctl3.CoolButton cmdCancel 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmByWayBusReport.frx":1040
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin RTComctl3.CoolButton cmdQuery 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmByWayBusReport.frx":105C
         PICN            =   "frmByWayBusReport.frx":1078
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin RTComctl3.CoolButton flbClose 
         ...
         MCOL            =   12632256
         MPTR            =   1
         MICON           =   "frmByWayBusReport.frx":1412
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmByWayBusReport"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
''**********************************************************
''* Source File Name:frmByWayBusReport.frm
''* Project Name:PSTBusMan.vbp
''* Engineer:范鹏东
''* Date Generated:2006/02/06
''* Last Revision Date:2006/02/06
''* Brief Description:途经班次表
''* Relational Document:
''**********************************************************
'
Option Explicit
Const cszTemplateFile = "途经班次表.xls"
Const cnTop = 1200
