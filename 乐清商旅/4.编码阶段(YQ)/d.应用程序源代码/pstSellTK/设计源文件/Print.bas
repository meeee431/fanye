...
Const cntickettype = 25
Const cnPersonName = 26 '实名制姓名
Const cnIDCardNo = 27 '实名制证件号
...
'    m_oFastReturn.OpenPort
    ...
    m_oFastReturn.SetCaption m_oAUser.UserID
...
Private Function PrintReturnSheetSlow(pszTicketNo As String, pszSheetID As String, psgReturnCharge As Double, psgTicketPrice As Double, pszOpTime As String, pszBusID As String, pszEndStation As String, pnReturnCount As String) As Long
    ...
    m_oPrintReturn.LabelSetCaption m_oAUser.UserID
...
'    m_oPrintReturn.LabelSetCaption "手续费"
    m_oPrintReturn.SetCurrentObject clRReturnCharge2  '
    m_oPrintReturn.LabelSetCaption Format(psgReturnCharge, "0.00") & "元"
    m_oPrintReturn.SetCurrentObject clRReturnCharge   '退票手续费
    m_oPrintReturn.LabelSetCaption Format(psgReturnCharge, "0.00")
    m_oPrintReturn.SetCurrentObject clREndStation  '
    m_oPrintReturn.LabelSetCaption pszEndStation
    m_oPrintReturn.SetCurrentObject clREndStation2  '
    m_oPrintReturn.LabelSetCaption pszEndStation
    m_oPrintReturn.SetCurrentObject clRBusID2  '
    m_oPrintReturn.LabelSetCaption pszBusID
    m_oPrintReturn.SetCurrentObject clRBusID  '
    m_oPrintReturn.LabelSetCaption pszBusID
    m_oPrintReturn.SetCurrentObject clRBusDate1
    m_oPrintReturn.LabelSetCaption ""
    m_oPrintReturn.SetCurrentObject clRBusDate2
    m_oPrintReturn.LabelSetCaption ""
...
''    m_oPrintReturn.SetCaption m_oAUser.UserID
''
...
, szSellStationName() As String, panInsurance() As Integer, Optional aszRealNameInfo As Variant) As Long
...
'    Open "lpt1:" For Output As #1
    ...
    Dim szticketType2 As String
    Const type1 As String = "本车票可携带一名免票儿童"
    Const type2 As String = "本车票不得携带免票儿童"
...
'        m_oFastPrint.OpenPort
    ...
    'Set oParam = m_oSell.ServerParamAtCurrentUnit
    If oParam Is Nothing Then Set oParam = m_oParam
'    bPrintAid = oParam.PrintAid
'    bPrintBarCode = oParam.PrintBarCode
...
'        End If
        ...
        If ArrayLength(aszRouteAndTime) <> 0 Then
            ...
            szCompanyName = aszRouteAndTime(5) '打印参运公司全称
        Else
            szRouteName = ""
            szScrollTime = ""
            szCompanyID = ""
        ...
        For i = 1 To nTicketCount(nCount)
            ...
            If aptTicketInfo(nCount).aptPrintTicketInfo(i).nTicketType = 5 Then
            szticketType2 = type1
            Else
            szticketType2 = type2
            End If
...
'                    否则打印车次时间加之前
            ...
            szCheckGate1 = Val(szCheckGate(nCount))       '得到检票口 检票口去掉“号”
            ...
            If m_bUseFastPrint Then
                ...
                '实名制姓名
                m_oFastPrint.SetObject cnPersonName
                m_oFastPrint.SetCaption aszRealNameInfo(nStart + i).szPersonName
                
                '实名制证件号
                m_oFastPrint.SetObject cnIDCardNo
                If Len(aszRealNameInfo(nStart + i).szIDCardNo) = 18 Then
                    m_oFastPrint.SetCaption Replace(aszRealNameInfo(nStart + i).szIDCardNo, Mid(aszRealNameInfo(nStart + i).szIDCardNo, Len(aszRealNameInfo(nStart + i).szIDCardNo) - 7, 4), "****")
                Else
                    m_oFastPrint.SetCaption aszRealNameInfo(nStart + i).szIDCardNo
                End If
            ...
            Else
                ...
                m_oPrintTicket.LabelSetCaption Left(Trim(szStartStationName), 2)
                ...
                m_oPrintTicket.SetCurrentObject cntickettype
                m_oPrintTicket.LabelSetCaption szticketType2
                ...
                m_oPrintTicket.SetCurrentObject cnCompany
                m_oPrintTicket.LabelSetCaption szCompanyName
                ...
                '实名制姓名
                m_oPrintTicket.SetCurrentObject cnPersonName
                m_oPrintTicket.LabelSetCaption aszRealNameInfo(nStart + i).szPersonName
                
                '实名制证件号
                m_oPrintTicket.SetCurrentObject cnIDCardNo
                If Len(aszRealNameInfo(nStart + i).szIDCardNo) = 18 Then
                    m_oPrintTicket.LabelSetCaption Replace(aszRealNameInfo(nStart + i).szIDCardNo, Mid(aszRealNameInfo(nStart + i).szIDCardNo, Len(aszRealNameInfo(nStart + i).szIDCardNo) - 7, 4), "****")
                Else
                    m_oPrintTicket.LabelSetCaption aszRealNameInfo(nStart + i).szIDCardNo
                End If
        ...
        Next
        nStart = nStart + nTicketCount(nCount)
    Next nCount
    If m_bUseFastPrint Then
'        m_oFastPrint.ClosePort
    End If
...
'**********************************************
    ...
    m_oPrintReturn.SetCurrentObject clRReturnCountStr  '
    m_oPrintReturn.LabelSetCaption "退票"
    ...
    m_oPrintReturn.SetCurrentObject clRReturnChargeStr2
    m_oPrintReturn.LabelSetCaption "退票手续费凭证"
    
    m_oPrintReturn.SetCurrentObject clRBusDate1
    m_oPrintReturn.LabelSetCaption Format(pdtBusDate, "yyyy-mm-dd")
    
    m_oPrintReturn.SetCurrentObject clRBusDate2
    m_oPrintReturn.LabelSetCaption Format(pdtBusDate, "yyyy-mm-dd")
    
    m_oPrintReturn.SetCurrentObject clRSheetIDStr
    m_oPrintReturn.LabelSetCaption "退"
    
    m_oPrintReturn.SetCurrentObject clRNowDate    '打印日期
    m_oPrintReturn.LabelSetCaption Now 'Format(Now, "YYYY-MM-DD hh:mm:ss")
    
    m_oPrintReturn.SetCurrentObject clRNowDate2    '打印日期
    m_oPrintReturn.LabelSetCaption Now 'Format(Now, "YYYY-MM-DD hh:mm:ss")
    
    m_oPrintReturn.SetCurrentObject clRUserID1  '打印工号
    m_oPrintReturn.LabelSetCaption m_oAUser.UserID
...
'打印票函数
Public Function PrintNetTicket(aptTicketInfo() As TPrintTicketParam, szBusDate() As String, nTicketCount() As Integer, szEndStation() As String _
, szOffTime() As String, szBusID() As String, szVehicleType() As String, szCheckGate() As String, bSaleChange() As Boolean, aszTerminateName() As String _
, szSellStationName() As String, panInsurance() As Integer, nBusType() As EBusType, pbIsTakeChild() As Boolean, Optional aszRealNameInfo As Variant) As Long
 ...
 #If PRINT_SHEET <> 0 Then
    ...
    Dim oParam As Object 'SystemParam
...
'        End If
        ...
        If ArrayLength(aszRouteAndTime) <> 0 Then
            ...
            szScrollTime = aszRouteAndTime(2)
            szCompanyID = aszRouteAndTime(3)
            szCompanyName = aszRouteAndTime(5)
            'szRouteID = aszRouteAndTime(6)
        Else
            szRouteName = ""
            szScrollTime = ""
            szCompanyID = ""
        ...
        szCompanyName = Format(Now, "MM-DD HH:MM")
        ...
        For i = 1 To nTicketCount(nCount)
            ...
            szUserID = m_oAUser.UserID    '得到工号
            If Len(szUserID) > 3 Then
                szUserID = Right(szUserID, 3)
            End If
...
'            Dim aszChangeRideEachRoute() As String
'
'            For k = 0 To ArrayLength(g_aszChangeRideEachOtherRoute) - 1
'                aszChangeRideEachRoute = Split(g_aszChangeRideEachOtherRoute(k), ",")
'                For j = 0 To ArrayLength(aszChangeRideEachRoute) - 1
'                    If szRouteID = aszChangeRideEachRoute(j) Then
'                        szCheckGate1 = ""
'                        Exit For
'                    End If
'                Next j
'            Next k
            ...
            Select Case Len(Trim(szCheckGate1))
                Case 0
                    szCheckGate1 = szCheckGate1 & Space(7)
                Case 1
                    szCheckGate1 = szCheckGate1 & Space(6)
                Case 2
                    szCheckGate1 = szCheckGate1 & Space(5)
...
'            For j = 1 To ArrayLength(m_aszBusType)
'                If nBusType(nCount) = m_aszBusType(j, 1) Then
'                    szBusType = "" ' m_aszBusType(j, 2)
'                    Exit For
'                End If
'            Next j
            ...
            If Format(szOffTime(nCount), "hh:mm") = cszScrollBus Then
                ...
                If oParam.ScrollBusTicketPrintDateType = 1 Then
                    '滚动
                    szOffTime1 = cszScrollBus
                ElseIf oParam.ScrollBusTicketPrintDateType = 2 Then
                    '上午之前或下午之前
                    If DateDiff("s", Time, cszMiddleTime) > 0 Then
                        szOffTime1 = "11:30" & cszScrollBusTime
                    Else
                        szOffTime1 = CStr(Format(szScrollTime, "hh:mm")) & cszScrollBusTime
                    End If
                Else
                    '发车时间之前
                    szOffTime1 = CStr(Format(szScrollTime, "hh:mm")) & cszScrollBusTime
            ...
            If m_bUseFastPrint Then
                ...
                m_oFastPrint.SetObject cnBusDate2
                m_oFastPrint.SetCaption Format(szDate, "yy-mm-dd")
                
                m_oFastPrint.SetObject cnBusID2
                m_oFastPrint.SetCaption szBusID1
                
                m_oFastPrint.SetObject cnSeat
                m_oFastPrint.SetCaption szTempSeat
                ...
                m_oFastPrint.SetObject cnTicketNO1
                m_oFastPrint.SetCaption szTicketNo & "网购"
                ...
                '车次类型
'                m_oFastPrint.SetObject cnBusType
'                m_oFastPrint.SetCaption szBusType
                
                '携童票标识 zyw
'                m_oFastPrint.SetObject cnIsTakeChild
'                m_oFastPrint.SetCaption IIf(pbIsTakeChild(i), "携 童", "")
            ...
            Else
                ...
                m_oPrintTicket.SetCurrentObject cnTicketType1
                m_oPrintTicket.LabelSetCaption IIf(pbIsTakeChild(i), "携 童", szTicketType1)
                ...
                m_oPrintTicket.SetCurrentObject cnBusDate2
                m_oPrintTicket.LabelSetCaption Format(szDate, "yy-mm-dd")
                ...
                m_oPrintTicket.SetCurrentObject cnSeat
                m_oPrintTicket.LabelSetCaption szTempSeat
                ...
                m_oPrintTicket.SetCurrentObject cnTicketNO1
                m_oPrintTicket.LabelSetCaption szTicketNo & "网购"
                ...
                '车次类型
'                m_oPrintTicket.SetCurrentObject cnBusType
'                m_oPrintTicket.LabelSetCaption szBusType
                
                '携童票
'                m_oPrintTicket.SetCurrentObject cnIsTakeChild
'                m_oPrintTicket.LabelSetCaption IIf(pbIsTakeChild(i), "携 童", "")
