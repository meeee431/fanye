...
' *   Last Revision Date:                                           *
' *******************************************************************
Public Sub ShowError(ByVal plErrNum As Long, Optional ByVal pszSource As String = "", Optional ByVal pszOrgMsg As String = "", Optional ByVal pbWantOrgMsg As Boolean = True)
    Dim szErrMsg As String, szSource As String
'    On Error GoTo Here
On Error Resume Next
    If pszSource <> "" Then
    ...
    If szErrMsg = "" Then
        If pszOrgMsg <> "" Then
            If Left(pszOrgMsg, Len(cszOrgErrMsgNote)) <> cszOrgErrMsgNote Then
                szErrMsg = szErrMsg & cszOrgErrMsgNote & pszOrgMsg
            Else
                szErrMsg = szErrMsg & pszOrgMsg
            End If
        Else
            szErrMsg = cszDefErrMsg
            If pbWantOrgMsg Then szErrMsg = szErrMsg & vbCrLf & cszOrgErrMsgNote & pszOrgMsg
