...
Begin VB.Form frmArrangeSection 
   ...
   Begin pstSettle.ucSuperCombo cboStartStation 
      Height          =   855
      Left            =   6510
      TabIndex        =   13
      Top             =   765
   ...
   Begin MSComctlLib.Toolbar tbSection 
      ...
      BorderStyle     =   1
   End
   Begin pstSettle.ucSuperCombo cboStation 
      Height          =   3105
      Left            =   6495
      TabIndex        =   14
      Top             =   1875
...
Private m_oBackBaseInfo As New BackBaseInfo
Private m_oRoute As New BackRoute
Private m_oBackSection As New BackSection
Private m_szStation As String
Private m_oSection As New Section


Private Sub cboStartStation_KeyPress(KeyAscii As Integer)
...
Private Sub Form_Load()
    '初始化对象
    m_oBackBaseInfo.Init g_oActiveUser
    m_oRoute.Init g_oActiveUser
    m_oBackSection.Init g_oActiveUser
...
Private Sub AppendSection()
    ...
    If lvRouteSection.ListItems.Count = 0 Then
        szStartStation = ResolveDisplay(cboStartStation.BoundText)     '取得起点站
    Else
...
Private Sub AddSectionToDB(pszStartStation As String, pszEndStation As String)
    ...
    If nResult = vbYes Then
        ...
        frmSection.m_eStatus = AddStatus
...
Private Sub FillStation()
    ...
    szaStation = oBaseInfo.GetStation
    ...
    Set cboStartStation.RowSource = rsStation
    cboStartStation.BoundField = "Code"
    cboStartStation.ListFields = "Input:6,Name:6,Code:9"
    cboStartStation.AppendWithFields "Code:9,Name"
...
'    Next i
    If nCount > 0 Then
        ...
        Else
            ...
            End If
        End If
        lblStartStation.Visible = True
        cboStartStation.Visible = False
    Else
        lblStartStation.Visible = False
        cboStartStation.Visible = True
...
Private Sub EditSection()
    ...
    On Error GoTo ErrorHandle
    If lvRouteSection.SelectedItem Is Nothing Then Exit Sub
    frmSection.m_eStatus = ModifyStatus
    frmSection.m_bRouteArrange = True
...
Private Sub RefreshRouteInfo()
    ...
    lblStartStation.Caption = MakeDisplayString(m_oRoute.StartStation, m_oRoute.StartStationName)
    
'    Dim i As Integer
    
'    For i = 1 To cboStartStation.ListCount
'        If Trim(Left(cboStartStation.List(i - 1), 10)) = m_oRoute.StartStation Then
'            cboStartStation.ListIndex = i - 1
'            Exit For
'        End If
'    Next i
    RefreshSection
