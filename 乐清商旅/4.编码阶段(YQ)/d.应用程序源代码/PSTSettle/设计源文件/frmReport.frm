...
'    Dim rsTemp As Recordset
    ...
    '赋票种
    aszTemp(1) = "费用项"
    If pszFileName = "车辆固定费用表.xls" Or pszFileName = "车次固定费用表.xls" Then
        '得到固定费用项
        Set arsTemp(1) = m_oReport.GetSplitItemInfoRs2(g_szFixFeeItem)
    Else
        Set arsTemp(1) = m_oReport.GetSplitItemInfoRs
    End If
    m_bNeedSave = True
