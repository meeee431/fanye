...
Begin VB.Form frmCompanyKindReport 
   BackColor       =   &H00E0E0E0&
   ...
   ClientTop       =   330
   ClientWidth     =   5340
   Icon            =   "frmCompanyKindReport.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3750
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmCompanyKindReport.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmCompanyKindReport.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmCompanyKindReport"
...
Const cszFileName = "公司分类营收报表.xls"
...
Private Sub cmdOk_Click()
    ...
    Dim i As Integer
    Set rsTemp = oDss.GetCompanyKindByBusDate(ResolveDisplay(txtCompanyID.Text), dtpBeginDate.Value, dtpEndDate.Value)
