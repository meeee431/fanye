...
Begin VB.Form frmUnitInterSellCon 
   BackColor       =   &H00E0E0E0&
   ...
   ClientTop       =   2610
   ClientWidth     =   6705
   HelpContextID   =   6001001
   Icon            =   "frmUnitInterSellCon.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSellCon.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSellCon.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSellCon.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmUnitInterSellCon"
...
Const cszFileName = "互连单位互售票统计报表模板.xls"
...
Private Sub cmdok_Click()
    ...
    Set m_rsData = oDss.ExUnitDateStat(aszUnit, dtpBeginDate.Value, dtpEndDate.Value)
