...
Begin VB.Form frmUnitInterSettle 
   BackColor       =   &H00E0E0E0&
   ...
   ClientTop       =   4275
   ClientWidth     =   6735
   HelpContextID   =   60000140
   Icon            =   "frmUnitInterSettle.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSettle.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSettle.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSettle.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmUnitInterSettle"
...
Const cszFileName = "互连互售统计结算报表模板.xls"
...
Private Sub cmdok_Click()
    ...
    Set m_rsData = oDss.UnitInterSettle(aszUnit, dtpBeginDate.Value, dtpEndDate.Value)
