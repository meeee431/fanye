...
Begin VB.Form frmSellerDayCon 
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSellerDayCon.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSellerDayCon.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSellerDayCon.frx":0038
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmSellerDayCon"
...
Const cszFileName = "售票员售票日报模板.xls"
...
'    dtpEndDate.Value = DateAdd("D", -1, DateAdd("M", 1, dtpBeginDate.Value))
    If nSelUserCount > 0 Then
        ...
        Next
        Set m_rsData = oSellerStat.SellerDateStatHaveTicket(aszUserID, dtpBeginDate.Value, dtpEndDate.Value)
    End If
