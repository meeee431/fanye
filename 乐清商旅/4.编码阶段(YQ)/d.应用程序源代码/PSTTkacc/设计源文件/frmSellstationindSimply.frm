...
Begin VB.Form frmSellstationindSimply 
   BackColor       =   &H00E0E0E0&
   ...
   ClientTop       =   330
   ClientWidth     =   6045
   Icon            =   "frmSellstationindSimply.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3915
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSellstationindSimply.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSellstationindSimply.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSellstationindSimply.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmSellstationindSimply"
