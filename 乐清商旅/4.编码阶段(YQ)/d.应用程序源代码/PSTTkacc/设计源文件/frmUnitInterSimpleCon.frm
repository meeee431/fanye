...
Begin VB.Form frmUnitInterSimpleCon 
   BackColor       =   &H00E0E0E0&
   ...
   ClientTop       =   3570
   ClientWidth     =   5265
   HelpContextID   =   60000310
   Icon            =   "frmUnitInterSimpleCon.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSimpleCon.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSimpleCon.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmUnitInterSimpleCon.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmUnitInterSimpleCon"
...
Const cszFileName = "互连单位售票简报模板.xls"
...
Private Sub cmdok_Click()
    ...
    Dim aszUnit(1 To 1) As String
    Dim oDss As New TicketUnitDim
    oDss.Init m_oActiveUser
    aszUnit(1) = ResolveDisplay(cboUnit.Text)
    Set m_rsData = oDss.UnitDateStat(aszUnit, dtpBeginDate.Value, dtpEndDate.Value, ResolveDisplay(cboSellStation.Text))
    ReDim m_vaCustomData(1 To 2, 1 To 2)
    
    m_vaCustomData(1, 1) = "统计单位"
    m_vaCustomData(1, 2) = cboUnit.Text
