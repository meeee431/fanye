...
Begin VB.Form frmInternetTkCount 
   BackColor       =   &H00E0E0E0&
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmInternetTkCount.frx":0000
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmInternetTkCount.frx":001C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmInternetTkCount.frx":0038
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmInternetTkCount"
...
Const cszFileName1 = "网上售票统计报表.xls"

Const cszFileName2 = "网上售票明细报表.xls"
...
Private Sub cmdok_Click()
    ...
    Set m_rsData = oDss.InternetTkCount(aszUnit, dtpBeginDate.Value, dtpEndDate.Value, bSellCount, IIf(cboSellStation.Text <> "", ResolveDisplay(cboSellStation.Text), ""))
