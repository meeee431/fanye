...
Begin VB.Form frmSplitCompanySimpleCon 
   BackColor       =   &H00E0E0E0&
   ...
   ClientTop       =   2730
   ClientWidth     =   6555
   HelpContextID   =   6000080
   Icon            =   "frmSplitCompanySimpleCon.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   4395
   ...
   Begin RTComctl3.CoolButton cmdChart 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSplitCompanySimpleCon.frx":000C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton CoolButton1 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSplitCompanySimpleCon.frx":0028
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdCancel 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSplitCompanySimpleCon.frx":0044
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin RTComctl3.CoolButton cmdOk 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmSplitCompanySimpleCon.frx":0060
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "frmSplitCompanySimpleCon"
...
Const cszFileName = "拆帐公司营收简报模板.xls"
...
Private Sub cmdChart_Click()
    ...
    If m_bBySaleTime Then
        If optCompany.Value Then
            Set rsTemp = oDss.GetSplitCompanySimpleCon(m_szCompanyCode, dtpBeginDate.Value, dtpEndDate.Value, ResolveDisplay(cboExtraStatus.Text), szSellStation)
        Else
            Set rsTemp = oDss.GetCombineSimply(dtpBeginDate.Value, dtpEndDate.Value, Val(cboBusSection.Text), ResolveDisplay(cboExtraStatus.Text), szSellStation)
        End If
    Else
        If optCompany.Value Then
            Set rsTemp = oDss.SplitCompanySimpleConByBusDate(m_szCompanyCode, dtpBeginDate.Value, dtpEndDate.Value, ResolveDisplay(cboExtraStatus.Text), szSellStation)
        Else
            Set rsTemp = oDss.GetCombineSimplyByBusDate(dtpBeginDate.Value, dtpEndDate.Value, Val(cboBusSection.Text), ResolveDisplay(cboExtraStatus.Text), szSellStation)
        End If
    End If
...
'    optCombine.Value = True
    optCompany_Click
    SetVisible True
    If m_bBySaleTime Then
        Me.Caption = "拆帐公司营收简报[按售票时间汇总]"
        lblCaption = "请输入售票的起止日期:"
    Else
        Me.Caption = "拆帐公司营收简报[按车次日期汇总]"
...
Private Sub SetVisible(pbVisible As Boolean)
    lblCombine.Visible = Not pbVisible
    cboBusSection.Visible = Not pbVisible
    lblCompany.Visible = pbVisible
    txtTransportCompanyID.Visible = pbVisible
