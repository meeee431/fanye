...
Public Const AUTOCANCELINTTK = "8888" '自动废票
Public Const AUTOCANCELTKID = "9999" '自动废票
Public Const GetNetTKCOUNT = "2003" '网上售票对帐
Public Const GetTKCOUNT = "2004" '代理售票对帐
Public Const GetNetTK = "2005" '取网上售票
Public Const CancelPreNetTK = "2006" '重打
Public Const UpdCardID = "2007" '更新银行卡号
Public Const GETALLSTATION = "2008" '取全部站点
Public Const GETALLSCHEDULESID = "2009" '取全部车次
Public Const GETSEAT_Self = "8012" '取座位

Public Const QuerySellDetail = "8013" '查询售票明细
Public Const QuerySellCount = "8014" '查询售票统计

Public Const InVaildUser = "8016" '验证用户
'=============================================================
'其他常量定义
'=============================================================
...
'        .MoveFirst
    ...
    '        szStr = szStr & FormatLen(TimeToPackage(!bus_start_time), cnBusRsLen_bus_start_time)
            szStr = szStr & FormatLen(!bus_kind, cnBusRsLen_bus_kind)
