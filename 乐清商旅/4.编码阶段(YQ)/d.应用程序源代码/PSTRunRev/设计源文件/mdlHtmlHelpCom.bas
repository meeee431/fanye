...
Public Function SetHTMLHelpStrings(Optional ByVal HelpFile As String = "SNHelp.chm", Optional HelpWinType As String = "SNhelp") As String
    SetHTMLHelpStrings = GetWinDir & "\Help\SNHelp\" & HelpFile
